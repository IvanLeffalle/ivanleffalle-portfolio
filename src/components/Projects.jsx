...
import { DiNodejsSmall, DiGithubBadge, DiHtml5, DiJavascript1, DiCss3 } from 'react-icons/di'; // Ensure these are installed
...
const projects = [
  {
    ...
    description: "Developed a responsive website using React with modern UI design.",
    links: {
  ...
  },
  {
    ...
    links: {
      site: "#",
      github: "https://github.com/IvanLeffalle/cse210-projects/tree/main/prove/Develop02",
    },
    technologies: [
  ...
  },
  {
    ...
    description: "Demonstrated encapsulation principles in this CSE210 project.",
    links: {
      site: "#",
      github: "https://github.com/IvanLeffalle/cse210-projects/tree/main/prove/Develop03",
    },
    technologies: [
      { name: 'C#', icon: <DiNodejsSmall className='text-customAccent' /> },
    ],
  },
  {
    ...
    links: {
      site: "#",
      github: "https://github.com/IvanLeffalle/cse210-projects/tree/main/prove/Develop05",
    },
    technologies: [
      { name: 'C#', icon: <DiNodejsSmall className='text-customAccent' /> },
    ],
  },
  {
    ...
    links: {
      site: "#",
      github: "https://github.com/IvanLeffalle/cse210-projects/tree/main/prove/Develop06",
    },
    technologies: [
      { name: 'C#', icon: <DiNodejsSmall className='text-customAccent' /> },
    ],
...
export const Projects = () => {
  ...
  return (
    <div className="max-w-[1200px] mx-auto p-6 md:my-20" id="portfolio">
      <h2 className="text-3xl font-bold text-gray-200 mb-8 text-center">Other Interesting Projects      </h2>
        ...
        {projects.map((project, index) => (
          <Reveal key={index}>
            ...
            >
              ...
              <p className="text-gray-300 mb-4 text-[16px]">{project.description}</p>
              <div className="grid grid-cols-2 gap-4">
                {project.technologies.map((tech, idx) => (
                  <div key={idx} className="flex items-center space-x-2">
                    <span className="text-gray-200 text-[13px]"><span>- </span>{tech.name}</span>
                  </div>
                ))}
              </div>
